...
def help_user(bot, update):
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕ JOIN OUR CHANNEL ⭕", url="https://t.me/CODERZHEX")]]),
        parse_mode="html",
...
async def about(bot, update):
    await bot.send_message(
        ...
        reply_to_message_id=update.message_id, 
        disable_web_page_preview = True, 
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕ Devoloper ⭕", url="https://t.me/maxxcoderz")]])  
    )
